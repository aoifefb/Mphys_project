"""
Code for finding contact angle of droplet by fitting the edge using young-laplace equation
integration along edge of droplet based on method from paper by F. Behroozi DOI:10.1119/1.5078512
Masters project by Aoife Baskill
requires image inputs in one folder
